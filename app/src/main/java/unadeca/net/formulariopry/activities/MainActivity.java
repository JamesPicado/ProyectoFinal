...
public class MainActivity extends AppCompatActivity {
    ...
    private void validacionBD(TextInputLayout n, TextInputLayout a, TextInputLayout e, TextInputLayout p, TextInputLayout o) throws Exception{
        if(n.getEditText().getText().toString().isEmpty()) throw  new Exception("Se ocupa el Nombre ");
        if(a.getEditText().getText().toString().isEmpty()) throw  new Exception("Se ocupa el Apellido ");
        if(e.getEditText().getText().toString().isEmpty()) throw  new Exception("Se ocupa la Edad ");
        if(p.getEditText().getText().toString().isEmpty()) throw  new Exception("Se ocupa la Nacionalidd ");
        if(o.getEditText().getText().toString().isEmpty()) throw  new Exception("Se necesita la ocupación ");
    }
